...
[![My Skills](https://skillicons.dev/icons?i=js,ts,py,react,redux,tailwind,vite,nodejs,express,postgres,mongodb,redis,prisma,docker,git,vercel,netlify,postman,jupyter,cloudinary&perline=10)](https://skillicons.dev)
